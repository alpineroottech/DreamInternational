function routeRow(title, slug, fromCity, toCity, fromAirport, toAirport, airline, duration, frequency, ticketType, order, featured, extra = {}) {
  return {
    title,
    slug,
    ticketType,
...
export function buildFlightRoutes() {
  const domestic = [
    routeRow("Kathmandu to Lukla", "kathmandu-to-lukla", "Kathmandu", "Lukla", "KTM", "LUA", "Tara Air / Summit Air / Sita Air", "30 min", "Multiple daily (weather permitting)", "domestic", 0, true, {
    ...
    routeRow("Kathmandu to Pokhara", "kathmandu-to-pokhara", "Kathmandu", "Pokhara", "KTM", "PKR", "Buddha Air / Yeti Airlines / Shree Airlines", "25 min", "10+ flights daily", "domestic", 1, true, {
    ...
    routeRow("Kathmandu to Bhairahawa", "kathmandu-to-bhairahawa", "Kathmandu", "Bhairahawa", "KTM", "BWA", "Buddha Air / Yeti Airlines", "30–45 min", "4–6 daily", "domestic", 2, false, {
    ...
    routeRow("Kathmandu to Bharatpur", "kathmandu-to-bharatpur", "Kathmandu", "Bharatpur", "KTM", "BHR", "Buddha Air / Yeti Airlines", "20 min", "5+ daily", "domestic", 3, false, {
    ...
    routeRow("Pokhara to Jomsom", "pokhara-to-jomsom", "Pokhara", "Jomsom", "PKR", "JMO", "Tara Air / Summit Air", "20 min", "Morning flights (weather dependent)", "domestic", 4, true, {
    ...
    routeRow("Everest Mountain Flight", "everest-mountain-flight", "Kathmandu", "Everest Region", "KTM", "—", "Buddha Air / Yeti Airlines", "50–60 min", "Daily early morning", "domestic", 5, true, {
    ...
    routeRow("Kathmandu to Bhadrapur", "kathmandu-to-bhadrapur", "Kathmandu", "Bhadrapur", "KTM", "BDP", "Buddha Air / Yeti Airlines", "45–55 min", "2–3 daily", "domestic", 6, false, {
    ...
    routeRow("Ramechhap to Lukla", "ramechhap-to-lukla", "Ramechhap", "Lukla", "RHP", "LUA", "Tara Air / Summit Air", "18 min", "Seasonal (peak trekking months)", "domestic", 7, false, {
    ...
    routeRow("Kathmandu to Nepalgunj", "kathmandu-to-nepalgunj", "Kathmandu", "Nepalgunj", "KTM", "KEP", "Buddha Air / Shree Airlines", "55 min", "3–4 daily", "domestic", 8, false, {
    ...
    routeRow("Kathmandu to Biratnagar", "kathmandu-to-biratnagar", "Kathmandu", "Biratnagar", "KTM", "BIR", "Yeti Airlines / Buddha Air", "40 min", "3–4 daily", "domestic", 9, false, {
    ...
    routeRow("Kathmandu to Dhangadhi", "kathmandu-to-dhangadhi", "Kathmandu", "Dhangadhi", "KTM", "DHI", "Buddha Air", "1h 10m", "2 daily", "domestic", 10, false, {
      description: "<p>Dhangadhi serves far-western Nepal — gateway to Khaptad National Park and the Sudurpashchim region.</p>",
    }),
    routeRow("Kathmandu to Tumlingtar", "kathmandu-to-tumlingtar", "Kathmandu", "Tumlingtar", "KTM", "TMI", "Tara Air", "50 min", "Several weekly", "domestic", 11, false, {
    ...
    routeRow("Kathmandu to Jomsom", "kathmandu-to-jomsom", "Kathmandu", "Jomsom", "KTM", "JMO", "Tara Air (via Pokhara)", "—", "Seasonal", "domestic", 12, false, {
  ...
  const international = [
    routeRow("Kathmandu to Delhi", "kathmandu-to-delhi", "Kathmandu", "Delhi", "KTM", "DEL", "Nepal Airlines / Air India / IndiGo", "1h 45m", "6+ flights daily", "international", 0, true, {
    ...
    routeRow("Kathmandu to Dubai", "kathmandu-to-dubai", "Kathmandu", "Dubai", "KTM", "DXB", "Flydubai / Emirates / Nepal Airlines", "4h 30m", "2–3 daily", "international", 1, true, {
    ...
    routeRow("Kathmandu to Doha", "kathmandu-to-doha", "Kathmandu", "Doha", "KTM", "DOH", "Qatar Airways / Himalaya Airlines", "4h 15m", "Daily", "international", 2, true, {
    ...
    routeRow("Kathmandu to Bangkok", "kathmandu-to-bangkok", "Kathmandu", "Bangkok", "KTM", "BKK", "Thai Airways / Nepal Airlines", "3h 10m", "Daily", "international", 3, true, {
    ...
    routeRow("Kathmandu to Singapore", "kathmandu-to-singapore", "Kathmandu", "Singapore", "KTM", "SIN", "Singapore Airlines / Scoot", "5h", "Daily", "international", 4, true, {
    ...
    routeRow("Kathmandu to Kuala Lumpur", "kathmandu-to-kuala-lumpur", "Kathmandu", "Kuala Lumpur", "KTM", "KUL", "AirAsia / Malindo Air / Nepal Airlines", "4h 40m", "4–5 weekly", "international", 5, false, {
    ...
    routeRow("Kathmandu to London", "kathmandu-to-london", "Kathmandu", "London", "KTM", "LHR", "Qatar Airways / Turkish Airlines / Emirates (1 stop)", "14–16h total", "Daily connections", "international", 6, true, {
    ...
    routeRow("Kathmandu to Mumbai", "kathmandu-to-mumbai", "Kathmandu", "Mumbai", "KTM", "BOM", "Nepal Airlines / Air India / IndiGo", "2h 30m", "3–4 daily", "international", 7, false, {
    ...
    routeRow("Kathmandu to Hong Kong", "kathmandu-to-hong-kong", "Kathmandu", "Hong Kong", "KTM", "HKG", "Cathay Pacific / Nepal Airlines", "4h 30m", "4 weekly", "international", 8, false, {
    ...
    routeRow("Kathmandu to Abu Dhabi", "kathmandu-to-abu-dhabi", "Kathmandu", "Abu Dhabi", "KTM", "AUH", "Etihad Airways / Air Arabia", "4h 45m", "Daily", "international", 9, false, {
    ...
    routeRow("Kathmandu to Tokyo (Narita)", "kathmandu-to-tokyo-narita", "Kathmandu", "Tokyo", "KTM", "NRT", "Nepal Airlines / Cathay Pacific (1 stop)", "10–12h total", "Daily connections", "international", 10, false, {
    ...
    routeRow("Kathmandu to Osaka", "kathmandu-to-osaka", "Kathmandu", "Osaka", "KTM", "KIX", "Various (1 stop via Bangkok/HK)", "11–13h total", "Several weekly", "international", 11, false, {
    ...
    routeRow("Kathmandu to Sydney", "kathmandu-to-sydney", "Kathmandu", "Sydney", "KTM", "SYD", "Qatar / Singapore Airlines (1–2 stops)", "16–20h total", "Daily connections", "international", 12, false, {
