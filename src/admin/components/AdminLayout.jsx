...
const NAV = [
  ...
  { section: "Content" },
  {
    to: "/admin/tours?market=nepal",
    label: "Nepal Tours",
    icon: "solar:mountains-outline",
  },
  {
    to: "/admin/tours?market=international",
  ...
  {
    to: "/admin/flightRoutes",
    label: "Flight Routes",
    icon: "solar:airplane-outline",
  },
  {
    to: "/admin/ticketing-pages",
    label: "Ticketing Pages",
          ...
          {visibleNav.map((item, i) =>
            item.section ? (
              ...
              >
                ...
                {item.soon && (
                  <span
                    className="badge bg-light text-secondary ms-auto"
                    style={{ fontSize: 10 }}
                  >
                    soon
                  </span>
        ...
        <header className="di-topbar">
          ...
          <div className="ms-auto d-flex align-items-center gap-3">
            ...
            <div className="position-relative">
              ...
              >
                <span
                  className="rounded-circle text-white d-grid"
                  style={{
                    width: 32,
                    height: 32,
                    placeItems: "center",
              ...
              {menuOpen && (
                ...
                >
                  ...
                  >
                    <Icon icon="solar:key-outline" className="me-1" />
                    Change password
                  </button>
                  <button
