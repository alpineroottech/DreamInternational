        ...
        <div className="hero-3" id="hero">
            ...
            >
                ...
                {[
                    ...
                    { img: "/assets/img/hero/hero_bg_3_4.jpg", title: "Explore Nepal with Dream International" },
                ].map((slide, index) => (
                            ...
                            <div className="container">
                                <div className="hero-style3">
                                    ...
                                    <p className="hero-text" data-ani="slideinleft" data-ani-delay="0.4s">
                                        Dream International is a Nepal travel management company for trekking, culture, and private custom trips.
                                    </p>
                        ...
                        <div className="container">
                            <div className="hero-style3">
                                <h1 className="hero-title" data-ani="slideinleft" data-ani-delay="0.2s">
                                    Travel with Dream International
                                </h1>
                                <p className="hero-text" data-ani="slideinleft" data-ani-delay="0.4s">
                                    Dream International is a Nepal travel management company with years of
