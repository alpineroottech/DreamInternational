                        ...
                        <div className="col-xl-4 col-lg-6">
                            <div className="about-contact-grid">
                                ...
                                <div className="about-contact-details">
                                    ...
                                    <p className="about-contact-details-text">
                                        <Link to="mailto:info@dreaminternationaltours.com">info@dreaminternationaltours.com</Link>
                                    </p>
                                    <p className="about-contact-details-text">
                                        <Link to="mailto:support@dreaminternationaltours.com">support@dreaminternationaltours.com</Link>
                                    </p>
                                </div>
                            </div>
                        </div>
